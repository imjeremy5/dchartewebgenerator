    ...
    if changes_text == "":
        if exceptions_text == "":
            if mon == "5 lead":
                ...
                flash("Transport:", "h6")
                flash(
                    "The patient stated they did not want to be transported by ambulance at this time. We informed the patient of the {}, up to and including death. Patient {} at any time if their condition changes or if they change their mind. Patient stated they understood. Patient {}".format(rof, callback, sign_refusal), "transport")
                flash(name, "sig")
            elif mon == "12 lead":
                flash("Dispatch:", "h1")
                flash(
                ...
                flash(treatment_text, "treatment")
                flash("Transport:", "h6")
                flash("The patient stated they did not want to be transported by ambulance at this time. We informed the patient of the {}, up to and including death. Patient {} at any time if their condition changes or if they change their mind. Patient stated they understood. Patient {}".format(rof, callback, sign_refusal), "transport")
                flash(name, "sig")
        else:
            if mon == "5 lead":
                flash("Dispatch:", "h1")
